...
class LocationTestCase {
    ...
    void testMoveLeft_basic() {
        ...
        assert 10 == location.moveListener.getNumMoves()
    }
    ...
    void testMoveRight_basic() {
        ...
        assert 0 == location.point.y
        assert 20 == location.moveListener.getNumMoves()
    }
    ...
    void testMoveUp_basic() {
        ...
        assert 30 == location.moveListener.getNumMoves()
    }
    ...
    void testMoveDown_basic() {
        ...
        assert 40 == location.moveListener.getNumMoves()
    }
}
